...
export function AttachmentPanel({
 ...
 return (
 <div className="space-y-3 shadow-card bg-background p-4">
 ...
 <div
 key={item.id}
 className="flex items-center justify-between gap-3 bg-white p-3 transition-all duration-150 hover:-translate-y-0.5 hover:shadow-floating"
 >
