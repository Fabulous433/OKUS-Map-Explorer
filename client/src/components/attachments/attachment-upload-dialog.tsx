        ...
        <div className="p-4 space-y-4">
          <div className="space-y-2">
            ...
            <Select value={documentType} onValueChange={setDocumentType}>
              <SelectTrigger className="rounded-none border-[2px] border-black font-mono text-sm">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="rounded-none border-[2px] border-black font-mono text-sm min-h-[96px]"
            />
          </div>
          ...
          <Button
            ...
            className="w-full rounded-none border-[3px] border-black bg-[#FF6B00] text-white font-mono font-bold"
