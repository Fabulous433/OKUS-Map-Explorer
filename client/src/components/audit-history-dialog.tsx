...
export default function AuditHistoryDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="rounded-none border-[4px] border-black max-w-3xl bg-white p-0 max-h-[90vh] overflow-y-auto">
        <DialogHeader className="p-4 border-b-[3px] border-black bg-black">
          <DialogTitle className="font-serif text-xl font-black text-[#FFFF00] flex items-center gap-2">
        ...
        <div className="p-4 space-y-3">
          {isLoading ? (
            ...
            items.map((item) => (
              <div key={item.id} className="border-[2px] border-black p-3 space-y-2">
