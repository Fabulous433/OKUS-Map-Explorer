...
export default function BackofficeMasterData() {
 ...
 <h1 className="font-sans text-xl font-black md:text-2xl">MASTER DATA</h1>
 ...
 <Input value={rekKode} onChange={(e) => setRekKode(e.target.value)} placeholder="Kode rekening" className="font-mono text-sm" />
 <Input value={rekNama} onChange={(e) => setRekNama(e.target.value)} placeholder="Nama rekening" className="font-mono text-sm" />
 <Input value={rekJenis} onChange={(e) => setRekJenis(e.target.value)} placeholder="Jenis pajak" className="font-mono text-sm" />
 <Button onClick={() => createRekening.mutate()} className="w-full font-mono text-xs md:w-auto">
 ...
 <article key={item.id} className="bg-white p-3 shadow-card">
 ...
 <span className={`inline-flex border px-2 py-1 font-mono text-[10px] font-bold ${item.isActive ? "border-green-700 bg-green-100 text-green-800" : "border-gray-400 bg-gray-100 text-gray-600"}`}>
 ...
 type="button"
 variant="outline"
 className="border border-red-600 font-mono text-[11px] font-bold text-red-600"
 ...
 <Table>
 <TableHeader>
 <TableRow className="bg-[#2d3436]">
 <TableHead className="text-white font-mono text-xs">Kode</TableHead>
 <TableHead className="text-white font-mono text-xs">Nama</TableHead>
 <TableHead className="text-white font-mono text-xs">Jenis</TableHead>
 <TableHead className="text-white font-mono text-xs">Aktif</TableHead>
 <TableHead className="text-white font-mono text-xs text-right">Aksi</TableHead>
 </TableRow>
 </TableHeader>
 <TableBody>
 {rekeningList.map((item) => (
 ...
 <Button size="icon" variant="outline" aria-label="Simpan" onClick={() => toggleRekening(item)}>
 <Save className="w-3.5 h-3.5" />
 </Button>
 <Button size="icon" variant="ghost" className="text-red-600" aria-label="Hapus" onClick={() => deleteRekening(item.id)}>
