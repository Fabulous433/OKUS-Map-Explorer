...
import { BarChart3, Users, Building2, Map, ChevronRight, Sparkles, Database } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/backoffice/master-data", label: "Master Data", icon: Database, match: "/backoffice/master-data" },
