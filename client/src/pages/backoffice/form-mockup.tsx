...
function MockupCard({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border-2 border-black/80 bg-white shadow-[0_10px_0_0_rgba(0,0,0,0.12)]">
      ...
      <div className="border-b border-black/10 bg-gradient-to-r from-white to-gray-50 p-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-serif text-xl font-black text-black">{title}</h3>
    ...
    >
      <div className="space-y-5">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Badge className="rounded-full border border-black bg-[#FFF3EB] text-[#B7410E] no-default-hover-elevate no-default-active-elevate">
            Draft
          </Badge>
          <Button className="h-10 rounded-xl border-2 border-black bg-[#FF6B00] px-5 font-mono font-bold text-white no-default-hover-elevate no-default-active-elevate">
            Simpan WP
          </Button>
  ...
  return (
    ...
    >
      <div className="space-y-5">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Badge className="rounded-full border border-black bg-[#FFFF00] text-black no-default-hover-elevate no-default-active-elevate">
            Active
          </Badge>
          <Button className="h-10 rounded-xl border-2 border-[#FFFF00] bg-black px-5 font-mono font-bold text-[#FFFF00] no-default-hover-elevate no-default-active-elevate">
            Simpan OP
          </Button>
          <Button variant="outline" className="h-10 rounded-xl border-2 border-black px-5 font-mono font-bold">
            Lihat Titik Peta
  ...
  return (
    <BackofficeLayout>
      <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_20%_0%,#FFF2E8_0%,#F7F7F7_48%,#FFFFFF_100%)] p-4 md:p-8">
        <div className="pointer-events-none absolute -top-16 right-10 h-44 w-44 rounded-full bg-[#FF6B00]/15 blur-3xl" />
        ...
        <div className="mx-auto max-w-7xl space-y-6" data-testid="backoffice-form-mockup-page">
          <header className="rounded-2xl border-2 border-black bg-white p-5 shadow-[0_8px_0_0_rgba(0,0,0,0.1)] md:p-6">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <p className="font-mono text-[11px] font-bold uppercase tracking-[0.24em] text-gray-500">UI Mockup Preview</p>
                <h1 className="font-serif text-2xl font-black text-black md:text-3xl">Form WP dan OP</h1>
              ...
              <Badge className="rounded-full border-2 border-black bg-[#FFF176] px-4 py-1 text-black no-default-hover-elevate no-default-active-elevate">
                Mockup Only
              </Badge>
            </div>
          </header>
          ...
          <Tabs defaultValue="wp" className="space-y-4">
            <TabsList className="h-auto gap-2 rounded-xl border-2 border-black bg-white p-1.5">
              <TabsTrigger
                value="wp"
                className="rounded-lg border border-transparent px-4 py-2 font-mono text-xs font-bold uppercase tracking-[0.14em] data-[state=active]:border-black data-[state=active]:bg-[#FF6B00] data-[state=active]:text-white"
              >
                Wajib Pajak
              </TabsTrigger>
              <TabsTrigger
                value="op"
                className="rounded-lg border border-transparent px-4 py-2 font-mono text-xs font-bold uppercase tracking-[0.14em] data-[state=active]:border-black data-[state=active]:bg-black data-[state=active]:text-[#FFFF00]"
              >
                Objek Pajak
              </TabsTrigger>
            </TabsList>
