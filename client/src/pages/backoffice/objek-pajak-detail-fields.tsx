    ...
    <div className="border-[2px] border-[#FF6B00] p-3 space-y-3 bg-orange-50">
      ...
      {isRestoran ? (
        <div>
          ...
          >
            <SelectTrigger className="rounded-none border-[2px] border-black font-mono text-sm" data-testid="select-klasifikasi-makanan">
    ...
    <div className="border-[2px] border-blue-600 p-3 space-y-3 bg-blue-50">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          >
            <SelectTrigger className="rounded-none border-[2px] border-black font-mono text-sm" data-testid="select-jenis-usaha-hotel">
              <SelectValue placeholder="Pilih" />
            </SelectTrigger>
            <SelectContent className="rounded-none border-[2px] border-black">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2 border-[2px] border-black bg-white p-2">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          ...
          <Select onValueChange={(v) => update("statusReklame", v)} value={String(detail.statusReklame ?? "baru")}>
            <SelectTrigger className="rounded-none border-[2px] border-black font-mono text-sm" data-testid="select-status-reklame">
              <SelectValue placeholder="Pilih" />
            </SelectTrigger>
            <SelectContent className="rounded-none border-[2px] border-black">
    ...
    <div className="border-[2px] border-green-600 p-3 space-y-3 bg-green-50">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          >
            <SelectTrigger className="rounded-none border-[2px] border-black font-mono text-sm" data-testid="select-jenis-usaha-parkir">
              <SelectValue placeholder="Pilih" />
            </SelectTrigger>
            <SelectContent className="rounded-none border-[2px] border-black">
...
function DetailFieldsPBJTTenagaListrik({ form }: { form: UseFormReturn<OPFormValues> }) {
  ...
  return (
    <div className="border-[2px] border-yellow-600 p-3 space-y-3 bg-yellow-50">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div>
          ...
          >
            <SelectTrigger className="rounded-none border-[2px] border-black font-mono text-sm" data-testid="select-jenis-tenaga-listrik">
              <SelectValue placeholder="Pilih" />
            </SelectTrigger>
            <SelectContent className="rounded-none border-[2px] border-black">
...
function DetailFieldsPajakAirTanah({ form }: { form: UseFormReturn<OPFormValues> }) {
  ...
  return (
    <div className="border-[2px] border-cyan-700 p-3 space-y-3 bg-cyan-50">
...
function DetailFieldsPajakWalet({ form }: { form: UseFormReturn<OPFormValues> }) {
  ...
  return (
    <div className="border-[2px] border-amber-800 p-3 space-y-3 bg-amber-50">
